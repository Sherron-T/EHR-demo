import type {
  Patient, Medication, Note, Appointment, Lab, Order, Document,
  Outcome, Message, Referral, PriorAuth, Vital, SafetyPlan,
} from '../context/DataContext';

// Seed data for the demo. Dates are generated relative to "today" via d(offset).
...
export const initialPriorAuths: PriorAuth[] = [
  {
...
export const initialSafetyPlans: SafetyPlan[] = [
  {
