  ...
  return (
    <div className="pb-12">
      ...
      {showDocModal && selectedDoc && (
        <DocumentViewerModal doc={selectedDoc} patientName={patient?.name} onClose={() => setShowDocModal(false)} />
      )}

      {/* ── Note Detail Modal ── */}
      {showNoteModal && selectedNote && (
        <NoteDetailModal note={selectedNote} onClose={() => setShowNoteModal(false)} />
      )}
